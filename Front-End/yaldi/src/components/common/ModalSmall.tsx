...
const ModalSmall: React.FC<ModalProps> = ({
  isOpen,
  onClose,
  children,
  title,
  ...
  return (
    ...
    >
      {/* 모달 본체: 흰색 배경, 그림자 */}
      <div
        className={`w-[500px] px-5 pb-2.5 relative bg-my-white rounded-[20px] inline-flex flex-col justify-start items-start gap-2.5 shadow-2xl max-h-[90vh] overflow-y-auto transform transition-all ${className}`}
        role="dialog"
        aria-modal="true"
